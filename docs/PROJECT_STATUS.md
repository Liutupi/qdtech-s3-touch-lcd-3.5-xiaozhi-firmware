...
- v1.7.42 (2026-06-24): Weather source now supports configurable Caiyun realtime weather first, with Open-Meteo fallback; weather GIF updates restart on every weather refresh
