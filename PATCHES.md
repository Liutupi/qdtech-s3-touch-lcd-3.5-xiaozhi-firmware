...
- v1.8.18 将“摇一摇实验室”的子页面统一为全屏布局，并以 SD 卡预渲染舞台和立体骰子帧升级骰子视觉；骰子页单独启用快速起摇、停摇判定与界面自动收敛保护，避免久摇、无限滚动和重复结算。图片只在骰子页载入 PSRAM，退出立即释放；缺少 SD 资源时自动回退原平面骰子。其他摇一摇玩法、Wi-Fi、OTA、音频与已验证功能不变，详见 `docs/V1818_PSEUDO3D_DICE_HANDOFF.md`。
...
- v1.8.16 在“摇一摇实验室”增加可选的“功德木鱼”：SD RGB565 视觉、触摸/BMI270 敲击、功德动画及受音频焦点保护的短木鱼音；详见 `docs/V1816_WOODEN_FISH_HANDOFF.md`。
- v1.8.17 增加“摇摇电影”和“摇摇书籍”：从 SD 卡各 250 条离线资料中随机推荐，使用全屏大封面与可滚动的完整介绍；复用现有 BMI270 与后台任务，不改网络、OTA、音频和其他已验证功能，详见 `docs/V1817_SHAKE_RECOMMENDATIONS_HANDOFF.md`。
